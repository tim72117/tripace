...
// <input type="date">(見 PlacePanel.tsx 的 .dateEdit 分支、
...
// 自成一套深色視覺會跟其餘元件(PlacePanel/GeoHotelSidebar 等)格格
...
export function DatePickerPopover({
  ...
  // (PlacePanel.tsx/GeoCandidateSidebar.tsx)沿用原本 <input type="date">
