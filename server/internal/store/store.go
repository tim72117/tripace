...
func Open(dsn string) (*Store, error) {
	...
	migrationOK := true
	if err := db.AutoMigrate(&userRow{}, &tripRow{}, &entryRow{}, &memberLink{}, &publicLinkRow{}, &adminUserRow{}, &adminSessionRow{}, &cliAuthSessionRow{}, &landmarkRow{}, &photoCacheRow{}, &placeDetailsCacheRow{}, &apiRequestLogRow{}, &geoAPICallLogRow{}); err != nil {
