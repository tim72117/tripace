...
// 工具呼叫),讓前端合併進旅程清單表格供使用者查看/編輯。entries 沿用
// NotifyRecommendedPlaces 的風格,用 []map[string]any 而非具名型別,避免 api
// 套件為了此簽章反向依賴 wanttools(見 wanttools.TripEntryPayload 的定義處)。
